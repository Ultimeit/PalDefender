# Python Пример
    ...
    В этом примере используются текущие конечные точки вознаграждения разделения REST.

!!! tip "поиск по идентификатору"
    Используйте [paldeck.cc/items](https://paldeck.cc/items) для `ItemID`, [paldeck.cc/pals](https://paldeck.cc/pals) для `PalID` и [paldeck.cc/technology](https://paldeck.cc/technology) для `TechID`.
