# Python 例
    ...
    この例では、現在の分割 REST 報酬エンドポイントを使用します。

!!! tip "ID検索"
    `ItemID` には [paldeck.cc/items](https://paldeck.cc/items)、`PalID` には [paldeck.cc/pals](https://paldeck.cc/pals)、`TechID` には [paldeck.cc/technology](https://paldeck.cc/technology) を使用します。
