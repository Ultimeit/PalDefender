# Python Exemple
    ...
    Cet exemple utilise les points de terminaison de récompense actuels REST.

!!! tip "Recherche d'identité"
    Utilisez [paldeck.cc/items](https://paldeck.cc/items) pour `ItemID`, [paldeck.cc/pals](https://paldeck.cc/pals) pour `PalID` et [paldeck.cc/technology](https://paldeck.cc/technology) pour `TechID`.
