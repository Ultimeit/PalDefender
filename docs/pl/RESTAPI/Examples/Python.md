...
Ten przykład korzysta z obecnych, osobnych punktów końcowych REST do przyznawania nagród.

!!! tip "Wyszukiwanie identyfikatorów"
    `ItemID` znajdziesz na [paldeck.cc/items](https://paldeck.cc/items), `PalID` na [paldeck.cc/pals](https://paldeck.cc/pals), a `TechID` na [paldeck.cc/technology](https://paldeck.cc/technology).
...
# Nie zapisuj prawdziwych tokenów w kodzie. Użyj zmiennej środowiskowej lub menedżera sekretów.
