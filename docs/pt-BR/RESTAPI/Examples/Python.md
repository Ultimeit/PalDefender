# Python Exemplo
    ...
    Este exemplo usa os endpoints de recompensa divididos atuais REST.

!!! tip "Pesquisa de ID"
    Use [paldeck.cc/items](https://paldeck.cc/items) para `ItemID`, [paldeck.cc/pals](https://paldeck.cc/pals) para `PalID` e [paldeck.cc/technology](https://paldeck.cc/technology) para `TechID`.
